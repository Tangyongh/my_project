package com.dingdingyijian.ddyj.jpush;
...
import static com.dingdingyijian.ddyj.jpush.TagAliasOperatorHelper.ACTION_SET;
...
public class ExampleUtil {
    ...
    public static String getAlias(Context context,LoginBean loginBean) {
        String alias = loginBean.getMobile() + loginBean.getId();
        //设置别名
