...
public interface RegisteredContract {
    ...
    abstract class Presenter extends BasePresenter<View> {
        //注册
        public abstract void getRegistered(HashMap<String, String> hashMap);
        //发送登录验证码
        ...
        //点击注册
        public abstract void  clickRegistered(BLButton btnRegister, EditText phone, EditText code,EditText pwd,EditText confirmPwd, CheckBox checkBox);
    ...
    interface Model {
        //注册
        void getRegistered( HashMap<String, String> hashMap, Context context, BaseModelCallBack callBack);
